...
namespace App.Core.Desktop
{
    public static class DebugManager
    {
        ...
        private static DataList<SqlLog> _logSQLBase = new DataList<SqlLog>();
        private static DataList<SqlLog> _logSQLSistema = new DataList<SqlLog>();

        public static bool Enable { get; set; }

        public static DataList<SqlLog> LogSQLBase
        {
            get { return _logSQLBase; }
            set { _logSQLBase = value; }
        }

        public static DataList<SqlLog> LogSQLSistema
        {
        ...
        private static void Create()
        {
            if (output.IsNull() || output.IsDisposed)
            {
                ...
                LogSQLBase = LogSQLBase ?? new DataList<SqlLog>();
                LogSQLSistema = LogSQLSistema ?? new DataList<SqlLog>();
            }
        }
    }
}