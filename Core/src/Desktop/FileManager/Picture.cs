...
namespace App.Core.Desktop
{
    ...
    public class Picture
    {
        ...
        {
            if (Bitmap == null || (Bitmap is Bitmap) == false)
            {
                return;
            }
            ...
            switch (FormatEnum)
            {
                case PictureFormat.Jpg: Format = ImageFormat.Jpeg;
                    break;
                case PictureFormat.Png: Format = ImageFormat.Png;
                    break;
            }
        ...
        public string Compress()
        {
            ...
            var output = Terminal.Execute(exeCmd);
        ...
        private void BlankBitmap()
        {
            ...
            foreach (string imageFile in ImageFiles)
            {
                ...
                // Update width of the final bitmap
                ...
                // Update height of the final bitmap
