...
namespace App.Core.Desktop
{
    public static class PictureBoxExtension
    {
        ...
        public static void AlignBox(this FlatPictureBox picBox)
        {
            ...
            switch (picBox.Align)
            {
                case Align.Center: picBox.Location = new Point(xCenter, yCenter);
                    break;
                case Align.Left: picBox.Location = new Point(xLeft, yCenter);
                    break;
                case Align.Right: picBox.Location = new Point(xRight, yCenter);
                    break;
                case Align.Top: picBox.Location = new Point(xCenter, yTop);
                    break;
                case Align.Bottom: picBox.Location = new Point(xCenter, yBottom);
                    break;
            }
        }
    }
