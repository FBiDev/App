...
namespace App.Core.Desktop
{
    public partial class FlatListView : ListView
    {
        public FlatListView()
        {
            ...
            ImagesSize = new Size(32, 32);
            ImagesPerRow = 5;

            ImagesOriginal = new List<Bitmap>();
            Titles = new List<string>();
            Descriptions = new List<string>();

            ImagesBorder = 2;
            ImagesBorderColor = Color.Gold;
            ImagesMargin = 6;
        ...
        public List<Bitmap> ImagesOriginal { get; set; }

        public List<string> Titles { get; set; }

        public List<string> Descriptions { get; set; }

        public int ImagesBorder { get; set; }

        public Color ImagesBorderColor { get; set; }

        public int ImagesMargin { get; set; }

        private List<Image> Images { get; set; }

        private Size ImagesSize { get; set; }

        private int ImagesPerRow { get; set; }
        ...
        public async Task AddImageList(List<Bitmap> imageList, Size newImagesSize, List<string> titles = null, List<string> descriptions = null)
        {
            ...
            if (newImagesSize.IsEmpty || (newImagesSize.Width == 1 && newImagesSize.Height == 1))
            {
                newImagesSize = new Size(2, 2);
            }
        ...
        private void FlatListView_ItemMouseHover(object sender, ListViewItemMouseHoverEventArgs e)
        {
